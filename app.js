...
// Basic DOM manipulation to change the value of currenrt score.
// document.querySelector('#current-'+ activePlayer).textContent = dice;
// document.querySelector('#current-'+activePlayer).innerHTML = '<em>' + dice + '</em>'

// Setting a variable to return the text content of the html value
...
function nextPlayer(){
  ...
  // Alternative way to right the switch code using if function
  // if (activePlayer === 0) {
  //   activePlayer = 1
  // }else {
  //   activePlayer = 0
